...
class TurismoHarvester(SingletonPlugin):
    '''
    A Test Harvester
    '''
    ...
    def info(self):
        ...
        * description: a small description of what the harvester does. This will
        ...
        '''
        return {'name': 'turismo', 'title': 'turismo.gub.uy',
            'description': 'Harvest some info databases from turismo.gub.uy'}
    ...
    def gather_stage(self, harvest_job):
        ...
        '''
        log.debug('in TurismoHarvester gather_stage')
    ...
    def fetch_stage(self, harvest_object):
        ...
        '''
        log.debug('in TurismoHarvester fetch_stage')
        # Get URL
        ...
        try:
            ...
            log.exception(e)
            self._save_object_error('Unable to get content for: %s: %r' % \
    ...
    def import_stage(self, harvest_object):
        ...
        :returns: True if everything went right, False if errors were found
        '''
        log.debug('in TurismoHarvester import_stage')
